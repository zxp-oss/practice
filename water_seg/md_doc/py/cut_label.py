...
def main(mask_input_path, output_dir, window_size=1024, overlap=256):
    ...
    # print(img_name)
    # img_name = mask_input_path.split("\\")[-1].split(".")[0][:-8]
    # print(img_name)
    # 读取输入mask图像
...
if __name__ == "__main__":
    mask_input_path = "./data/label"
    output_dir = "./caijian/label"
    ...
    for index, mask_file in enumerate(mask_input_list):
        ...
        main(mask_full_path, output_dir, window_size=1024, overlap=256)
