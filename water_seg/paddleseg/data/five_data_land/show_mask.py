...
# 定义地物类型的颜色字典
# land_cover_colors = {
#     0: (0, 0, 0),  # No-data regions - Black
#     1: (255, 255, 255),  # Background - White
#     2: (255, 0, 0),  # Building - Red
#     3: (0, 255, 0),  # Road - Green
#     4: (0, 0, 255),  # Water - Blue
#     5: (255, 255, 0),  # Barren - Yellow
#     6: (0, 255, 255),  # Forest - Cyan
#     7: (255, 0, 255)  # Agriculture - Magenta
# }
#
# land_cover_types = {
#     0: 'No-data regions',
...
# 读取图片
image_path = '/home/zxp/test_project/PaddleSeg-release-2.9/data/five_data_land/labels/GF2_PMS1__L1A0000564539-MSS1_tile_50.png'
