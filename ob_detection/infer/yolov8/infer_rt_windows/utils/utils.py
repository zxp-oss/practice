...
import os
os.environ["CUDA_VISIBLE_DEVICES"] = "0"  # 选择第一个 GPU
...
class BaseEngine(object):
    def __init__(self, engine_path,confidence_thres, iou_thres):
        ...
        self.std = None
        self.n_classes = 20
        self.class_names = ["A2", "A10", "A3", "A19", "A1", "A13", "A20", "A15", "A16", "A17", "A12", "A5", "A14", "A7", "A9", "A4", "A18","A8", "A11", "A6"]
    ...
    def postprocess(self, input_image, output):
        ...
        y_factor = img_height / image_height
    ...
    def inference(self, img_path, end2end=False,is_slide=False):
        if is_slide:
            origin_img=img_path
        else:
        ...
        if is_slide:
            ...
            return self.postprocess(origin_img, data)
    # @staticmethods
