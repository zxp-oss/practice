...
class YOLOv8:
    ...
    def draw_detections(self, img, box, score, class_id, rotation):
        ...
        cv2.circle(img, (x_center,y_center), 1, (0,255,255), 2)
    ...
    def postprocess(self, input_image, output):
        ...
        for i in range(rows):
            ...
            if max_score >= self.confidence_thres:
                ...
                ratation_boxes.append((((2*left+width)//2, (2*top+height)//2),( width, height),outputs[i][-1]*180/np.pi))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img", type=str, default=str("img/1414.jpg"), help="Path to input image.")
