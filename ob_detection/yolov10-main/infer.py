    ...
    def postprocess(self, input_image, output):
        ...
        for i in range(rows):
            ...
            if max_score >= self.confidence_thres:
                ...
                boxes.append([int(new_bbox[0]), int(new_bbox[1]), int(new_bbox[2] - new_bbox[0]),
                              int(new_bbox[3] - new_bbox[1])])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="runs/detect/train5/weights/best.onnx", help="Input your ONNX model.")
    parser.add_argument("--img", type=str, default="VOCdevkit/images/test2007/Image_20191006232359787.jpg", help="Path to input image.")
